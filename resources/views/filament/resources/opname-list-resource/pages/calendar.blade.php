    ...
    <div class="h-screen w-full flex flex-col overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950">
        ...
        <div class="relative z-10 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-center gap-4">
                <div class="h-16 w-16 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center text-4xl shadow-xl border border-white/30">
                    📅
                </div>
                <div>
                    <h2 class="text-3xl font-bold text-white drop-shadow-lg">Kalender Janjian</h2>
                    <p class="text-sm text-blue-100/90 backdrop-blur-sm">Kelola dan lihat semua appointment dengan mudah</p>
                </div>
            </div>
            <div class="flex flex-wrap gap-2">
                <x-filament::button color="white" icon="heroicon-o-chevron-left" wire:click="goToPreviousMonth" class="shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                    ← Bulan Sebelumnya
                </x-filament::button>
                <x-filament::button color="white" icon="heroicon-o-calendar" wire:click="goToToday" class="shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                    Hari Ini
                </x-filament::button>
                <x-filament::button color="white" icon="heroicon-o-chevron-right" wire:click="goToNextMonth" class="shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                    Bulan Selanjutnya →
                </x-filament::button>
            </div>
        </div>
        ...
        <x-slot name="heading">
            <div class="flex items-center gap-3">
                ...
                <span class="text-lg font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent dark:from-gray-100 dark:to-gray-300">Kalender Janjian Bulanan</span>
            </div>
        </x-slot>
