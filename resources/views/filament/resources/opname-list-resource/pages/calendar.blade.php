<x-filament::page>
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Kalender Janjian</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Lihat seluruh appointment per bulan.</p>
        </div>
        <div class="flex flex-wrap gap-2">
            <x-filament::button color="gray" icon="heroicon-o-chevron-left" wire:click="goToPreviousMonth">
                Bulan Sebelumnya
            </x-filament::button>
            <x-filament::button color="gray" icon="heroicon-o-home" wire:click="goToToday">
                Bulan Ini
            </x-filament::button>
            ...
            @foreach ($calendarWeeks as $week)
                <div class="grid grid-cols-7 gap-2">
                    @foreach ($week as $day)
                        ...
                        @endphp
                        <div @class([
                            'min-h-[110px] rounded-lg border bg-white p-2 text-xs shadow-sm transition dark:bg-gray-900/60',
