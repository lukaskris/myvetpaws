    ...
    <x-filament::card class="overflow-hidden">
        <div class="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-4">
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h3 class="text-xl font-bold text-white">📅 Kalender Janjian</h3>
                    <p class="text-sm text-blue-100">Kelola dan lihat semua appointment dengan mudah</p>
                </div>
                <div class="flex flex-wrap gap-2">
                    <x-filament::button color="white" size="sm" icon="heroicon-o-chevron-left" wire:click="goToPreviousMonth">
                        ← Sebelumnya
                    </x-filament::button>
                    <x-filament::button color="white" size="sm" icon="heroicon-o-calendar" wire:click="goToToday">
                        Hari Ini
                    </x-filament::button>
                    <x-filament::button color="white" size="sm" icon="heroicon-o-chevron-right" wire:click="goToNextMonth">
                        Selanjutnya →
                    </x-filament::button>
                </div>
            </div>
